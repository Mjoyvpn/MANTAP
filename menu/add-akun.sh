...
echo -e "=> TELCO   : ws://bugcom/xraytrojanws" | tee -a /etc/log-create-user.log
...
echo -e "=> TELCO   : ws://bugcom/xrayws" | tee -a /etc/log-create-user.log
echo -e "====== Import Config From Clipboard =======" | tee -a /etc/log-create-user.log
...
echo -e "=> TELCO   : ws://bugcom/xrayvws" | tee -a /etc/log-create-user.log
echo -e "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" | tee -a /etc/log-create-user.log
